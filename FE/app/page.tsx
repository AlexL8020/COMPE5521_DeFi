      ...
      <main>
        <section className="py-20 px-4 text-center bg-gradient-to-b from-background to-muted">
          <div className="container max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-6">Fund Your Education with Crypto</h1>
            <p className="text-xl md:text-2xl text-muted-foreground mb-10 max-w-2xl mx-auto">
              Create crowdfunding campaigns for tuition, projects, or startups and receive support from global backers
              in cryptocurrency.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center p-6 rounded-lg border-2 bg-card">
              ...
              <p className="text-muted-foreground">
                Share your educational goals, projects, or startup ideas with the community.
              </p>
            </div>
            <div className="flex flex-col items-center text-center p-6 rounded-lg border-2 bg-card">
              <div className="h-12 w-12 rounded-full bg-primary/10 flex items-center justify-center mb-4">
              ...
              <h3 className="text-xl font-semibold mb-2">Receive Global Support</h3>
              <p className="text-muted-foreground">
                Connect with backers worldwide who believe in your potential and vision.
              </p>
            </div>
            <div className="flex flex-col items-center text-center p-6 rounded-lg border-2 bg-card">
              <div className="h-12 w-12 rounded-full bg-primary/10 flex items-center justify-center mb-4">
              ...
              <p className="text-muted-foreground">
                Use the funds to pay for tuition, build your project, or launch your startup.
              </p>
            </div>
          </div>
        </section>
                      ...
                      <div className="space-y-2">
                        <div className="w-full bg-muted rounded-full h-2">
                          <div
                            ...
                            style={{ width: i === 1 ? "75%" : i === 2 ? "45%" : "60%" }}
                          ></div>
                        </div>
                        <div className="flex justify-between text-sm">
                          <span className="font-medium">
                            {i === 1 ? "3.75 ETH" : i === 2 ? "2.25 ETH" : "3 ETH"} raised
                          </span>
                          <span className="text-muted-foreground">
                            {i === 1 ? "75%" : i === 2 ? "45%" : "60%"} of {i === 1 ? "5 ETH" : "5 ETH"}
                          </span>
                        </div>
                      </div>
                    </div>
        ...
        <div className="container py-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Empowering students through decentralized crowdfunding.</p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <Link href="/campaigns/create" className="text-muted-foreground hover:text-foreground">
                    Start a Campaign
                  </Link>
                </li>
                <li>
          ...
          <div className="border-t mt-8 pt-8 text-center text-sm text-muted-foreground">
            <p>© {new Date().getFullYear()} StudentFund. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
